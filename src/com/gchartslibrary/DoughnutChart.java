    ...
    public void draw(Canvas canvas, int x, int y, int width, int height, Paint paint) {
        ...
        for (int i = 0; i < sLength; i++) {
            ...
            if (i + 1 == sLength && mRenderer.getRenderers().get(ClickedArc.INDEX).isClicked()) {
                ...
                // int[] colors = { color, colors[ClickedArc.POS] };
                RadialGradient gradient3 = new RadialGradient(mCenterX, mCenterY, radius, colorClicked, null, android.graphics.Shader.TileMode.CLAMP);
                paint3.setShader(gradient3);
                paint3.setAntiAlias(true);
            ...
            if (i == 4) {
                ...
                paint.setStyle(Style.FILL);
                oval = new RectF(mCenterX - radius / 2, mCenterY - radius / 2, mCenterX + radius / 2, mCenterY + radius / 2);
